<?php namespace App\Http\Controllers;
	...
	class AdminDaftarUraianTugasController extends \crocodicstudio\crudbooster\controllers\CBController {

	    public function cbInit() {

			# START CONFIGURATION DO NOT REMOVE THIS LINE
			$this->title_field = "nama_posisi";
			$this->limit = "10";
			...
			$this->table = "daftar_uraian_tugas";
			...
			$this->col[] = ["label"=>"Bidang / Sub Bidang","name"=>"sub_bidang_id","name"=>"sub_bidang_id","join"=>"enumeration,value"];
			...
			$this->form[] = ['label'=>'Bidang/Sub Bidang','name'=>'sub_bidang_id','type'=>'radio','width'=>'col-sm-10','datatable'=>'enumeration,value','datatable_where'=>'`key`=\'SubBidang\''];
			//$this->form[] = ['label'=>'Waktu Pelaksanaan','name'=>'waktu_pelaksanaan','type'=>'date','validation'=>'required|date','width'=>'col-sm-10'];
			# END FORM DO NOT REMOVE THIS LINE

			# OLD START FORM
			//$this->form = [];
			//$this->form[] = ["label"=>"Nama Posisi","name"=>"nama_posisi","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
			//$this->form[] = ["label"=>"Nama Proyek","name"=>"nama_proyek","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
			//$this->form[] = ["label"=>"Uraian Tugas","name"=>"uraian_tugas","type"=>"textarea","required"=>TRUE,"validation"=>"required|string|min:5|max:5000"];
			//$this->form[] = ["label"=>"Waktu Pelaksanaan","name"=>"waktu_pelaksanaan","type"=>"date","required"=>TRUE,"validation"=>"required|date"];
