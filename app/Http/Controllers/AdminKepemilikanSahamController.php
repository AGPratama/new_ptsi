<?php namespace App\Http\Controllers;
	...
	class AdminKepemilikanSahamController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col[] = ["label"=>"Saham Presentase","name"=>"saham_presentase"];
			...
			$this->form[] = ['label'=>'Saham Presentase / Lembar','name'=>'saham_presentase','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			...
			//$this->form[] = ["label"=>"No Ktp","name"=>"no_ktp","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
			//$this->form[] = ["label"=>"Alamat","name"=>"alamat","type"=>"textarea","required"=>TRUE,"validation"=>"required|string|min:5|max:5000"];
			//$this->form[] = ["label"=>"Saham Presentase","name"=>"saham_presentase","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
