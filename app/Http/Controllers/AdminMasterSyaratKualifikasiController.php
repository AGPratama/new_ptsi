<?php namespace App\Http\Controllers;
	...
	class AdminMasterSyaratKualifikasiController extends \crocodicstudio\crudbooster\controllers\CBController {

	    public function cbInit() {
			#Custom List
			$this->isCustomList=true;
			$this->customViewFileName='MasterSyaratKualifikasi';
