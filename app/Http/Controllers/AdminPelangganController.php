<?php namespace App\Http\Controllers;
	...
	class AdminPelangganController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->title_field = "nama_pengguna_jasa";
			$this->limit = "10";
			...
			$this->col[] = ["label"=>"No Telp Cp","name"=>"no_telp_cp"];
			...
			$this->form[] = ['label'=>'No Telp Cp','name'=>'no_telp_cp','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			...
			//$this->form[] = ['label'=>'No Telp Cp','name'=>'no_telp_cp','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			//$this->form[] = ['label'=>'Alamat','name'=>'alamat','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			//$this->form[] = ['label'=>'Negara','name'=>'negara','type'=>'text','width'=>'col-sm-10'];
			//$this->form[] = ['label'=>'Kecamatan','name'=>'kecamatan','type'=>'text','width'=>'col-sm-10'];
			//$this->form[] = ['label'=>'Kelurahan','name'=>'kelurahan','type'=>'text','width'=>'col-sm-10'];
			//$this->form[] = ['label'=>'Kode Pos','name'=>'kode_pos','type'=>'number','width'=>'col-sm-10'];
			# OLD END FORM
