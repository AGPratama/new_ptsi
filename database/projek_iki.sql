...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 08, 2018 at 02:45 AM
...
--
-- Dumping data for table `daftar_uraian_tugas`
--
...
--
-- Dumping data for table `kepemilikan_saham`
--
...
--
-- Dumping data for table `master_syarat_kualifikasi`
--
...
--
-- Dumping data for table `master_syarat_kualifikasi_detail`
--
...
--
-- Dumping data for table `pengalaman_uraian_kerja`
--
...
--
-- Dumping data for table `pengurus_badan_usaha`
--
...
(1, 'testing', '1234', '2345', 2, 21, '82734', 'wiuerkhwe', 'uploads/1/2018-11/test.pdf', '128386', '10', 22, 25, 'sdfsd', 'uploads/1/2018-11/test.pdf', 'ok', 'uploads/1/2018-11/test.pdf', '1837', 'ja', NULL, '2018-11-01', '2018-11-02', '2018-11-03', '2018-11-04', '2018-11-05', '2018-11-06', NULL, '2018-11-06 03:50:34', NULL);
...
--
-- Dumping data for table `tender_syarat_kualifikasi`
--
...
--
-- Dumping data for table `tender_syarat_kualifikasi_detail`
--
...
--
-- Indexes for table `daftar_uraian_tugas`
--
...
--
-- Indexes for table `kepemilikan_saham`
--
...
--
-- Indexes for table `master_syarat_kualifikasi`
--
...
--
-- Indexes for table `master_syarat_kualifikasi_detail`
--
...
--
-- Indexes for table `pengalaman_uraian_kerja`
--
...
--
-- Indexes for table `pengurus_badan_usaha`
--
...
--
-- Indexes for table `tender_syarat_kualifikasi`
--
...
--
-- Indexes for table `tender_syarat_kualifikasi_detail`
--
...
--
-- AUTO_INCREMENT for table `daftar_uraian_tugas`
--
ALTER TABLE `daftar_uraian_tugas`
...
--
-- AUTO_INCREMENT for table `kepemilikan_saham`
--
ALTER TABLE `kepemilikan_saham`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `master_syarat_kualifikasi`
--
ALTER TABLE `master_syarat_kualifikasi`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=63;

--
-- AUTO_INCREMENT for table `master_syarat_kualifikasi_detail`
--
ALTER TABLE `master_syarat_kualifikasi_detail`
...
--
-- AUTO_INCREMENT for table `pengalaman_uraian_kerja`
--
ALTER TABLE `pengalaman_uraian_kerja`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `pengurus_badan_usaha`
--
ALTER TABLE `pengurus_badan_usaha`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
-- AUTO_INCREMENT for table `tender_syarat_kualifikasi`
--
ALTER TABLE `tender_syarat_kualifikasi`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;

--
-- AUTO_INCREMENT for table `tender_syarat_kualifikasi_detail`
--
ALTER TABLE `tender_syarat_kualifikasi_detail`
...
--
-- Constraints for table `daftar_uraian_tugas`
--
ALTER TABLE `daftar_uraian_tugas`
...
--
-- Constraints for table `kepemilikan_saham`
--
ALTER TABLE `kepemilikan_saham`
...
--
-- Constraints for table `master_syarat_kualifikasi`
--
ALTER TABLE `master_syarat_kualifikasi`
...
--
-- Constraints for table `master_syarat_kualifikasi_detail`
--
ALTER TABLE `master_syarat_kualifikasi_detail`
...
--
-- Constraints for table `pengalaman_uraian_kerja`
--
ALTER TABLE `pengalaman_uraian_kerja`
...
--
-- Constraints for table `pengurus_badan_usaha`
--
ALTER TABLE `pengurus_badan_usaha`
...
--
-- Constraints for table `tender_syarat_kualifikasi`
--
ALTER TABLE `tender_syarat_kualifikasi`
...
--
-- Constraints for table `tender_syarat_kualifikasi_detail`
--
ALTER TABLE `tender_syarat_kualifikasi_detail`
