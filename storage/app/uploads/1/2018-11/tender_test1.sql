...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 31 Okt 2018 pada 00.49
...
INSERT INTO `tender` (`id`, `nama_tender`, `no_tender`, `no_berita_acara`, `pengguna_jasa_id`, `metode_kualifikasi_id`, `no_kualifikasi`, `dokumen_tender_text`, `dokument_tender_file`, `nilai_pagu`, `nilai_hps`, `metode_dokumen_id`, `metode_evaluasi_id`, `bidbond_text`, `bidbond_file`, `hasil_tender_text`, `hasil_tender_file`, `ao_name`, `lainnya`, `status_dokumen`, `jadwal_upload_dokumen_prakualifikasi`, `jadwal_pembuktian_prakualifikasi`, `jadwal_download_dokumen_pemilihan`, `jadwal_pemberian_penjelasan`, `jadwal_upload_dokumen_penawaran`, `jadwal_pengumuman_pemenang`) VALUES
