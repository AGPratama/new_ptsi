    ...
    <div class="box">
        <div class="box-header">
            @if($button_bulk_action && ( ($button_delete && CRUDBooster::isDelete()) || $button_selected) )
                <div class="col-md-4 pl-0 custom-bulk-action">
            ...
            @endif
            <div class="box-tools <?php if($button_bulk_action && ( ($button_delete && CRUDBooster::isDelete()) || $button_selected)){echo'col-md-8';}else{echo'col-md-12';};?> pr-0 text-right custom-box-tool" style="position: relative;margin-top: -5px;margin-right: -10px">
                ...
                <form method='get' id='form-limit-paging' style="display:inline-block" action='{{Request::url()}}'>
                    ...
                    <div class="input-group">
                        <select onchange="$('#form-limit-paging').submit()" name='limit' style="width: 64px;" class='form-control input-sm'>
