...
class CBController extends Controller
{
    ...
    public function cbLoader()
    {
        ...
        # Ini Cutom
        $this->data['isCustomList']=$this->isCustomList;
        $this->data['customViewFileName']=$this->customViewFileName;
        #sampai ini
            ...
            foreach ($select_column as $sk => $s) {
                ...
                if (CRUDBooster::isForeignKey2($colname)) {
                    ...
                    if (intval($value->$s)) {
                        ...
                        try {
                            $relation_exists = DB::table("enumeration")->where("value","like","%".$value->$s."%")->first();
                            if ($relation_exists) {
                                $relation_id = $relation_exists->id;
