...
<div dw-loading="save" dw-loading-options="{className:'custom-loading',spinner:false,text:''}" class="loader"></div>
<div id="context"></div>
...
<!-- Content Wrapper. Contains page content -->
    <div class="content-wrapper">
        ...
        <section class="content-header" style="padding: 10px 10px 0 10px;">
            <?php
            $module = CRUDBooster::getCurrentModule();
            ?>
            @if($module)
                <div>
                    <h1 style='font-size: 2rem; margin: 0 0 5px; '><i class='{{$module->icon}}'></i> {{($page_title)?:$module->name}} &nbsp;&nbsp;</h1>
