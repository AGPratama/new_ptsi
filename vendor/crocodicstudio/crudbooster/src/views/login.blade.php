    ...
    <div class="login-box-body">
        ...
        @if ( Session::get('message') != '' )
            <div class='alert alert-warning' id="alertError">
                {{ Session::get('message') }}
                <a class="pull-right" style="cursor:pointer;" onClick="closeAlert()"><i class="fa fa-close"></i></a>
            </div>
        @endif
        ...
        <form autocomplete='off' action="{{ route('postLogin') }}" method="post">
            ...
            <div class="form-group has-feedback">
                <input autocomplete='off' type="password" class="form-control" oninput="showCaptcha()" id="password" name='password' required placeholder="Password"/>
                <span class="glyphicon glyphicon-lock form-control-feedback"></span>
            </div>
            <div class="form-group has-feedback text-center" id="show">
            <?=captcha_img();?>
            </div>
            <div class="form-group has-feedback" id="show1">
                <input autocomplete='off' type="text" class="form-control" name='captcha' required/>
            </div>
